...
TUNES = [
    ...
    # Round 2 brief (Wells): confident, bright, optimistic, minimal —
    # a coding tool, not a game. Lots of space, rising phrases, major keys.
    ("CUPERTINO", 104,   # a boot chime stretched into a loop
     [("C5",1),("R",.5),("E5",.5),("G5",1),("R",1),("A5",2),("R",2),
      ("G5",1),("R",.5),("E5",.5),("D5",1),("R",1),("C5",2),("R",2)],
     [("C3",4),("F2",4),("G2",4),("C3",4)]),
    ("MONTEREY", 112,   # quartal riff, punchy but spare
     [("G4",.5),("C5",.5),("D5",1),("R",2),
      ("G4",.5),("C5",.5),("E5",1),("R",2),
      ("A4",.5),("D5",.5),("E5",1),("R",2),
      ("G5",1),("E5",.5),("D5",.5),("C5",2)],
     [("C3",1),("R",3),("C3",1),("R",3),("F2",1),("R",3),
      ("G2",1),("C3",1),("R",2)]),
    ("SUNRISE", 120,   # each bar climbs a little higher
     [("G4",.5),("A4",.5),("C5",1),("R",2),
      ("C5",.5),("D5",.5),("E5",1),("R",2),
      ("E5",.5),("G5",.5),("A5",1),("R",2),
      ("G5",2),("R",2)],
     [("C3",2),("G2",2),("A2",2),("E2",2),("F2",2),("C3",2),("G2",2),("C3",2)]),
    ("READY", 96,   # a two-note "prompt is up" motif, mostly silence
     [("C5",.5),("G5",.5),("R",3),
      ("C5",.5),("A5",.5),("R",3),
      ("C5",.5),("E5",.5),("G5",.5),("R",2.5),
      ("D5",.5),("E5",.5),("G5",1),("R",2)],
     [("C3",.5),("R",3.5),("C3",.5),("R",3.5),("C3",.5),("R",3.5),
      ("G2",.5),("R",1.5),("C3",2)]),
]
